...
import NumericalEarth.CoupledModels: reference_density, heat_capacity
...
earth_model = CoupledModel(ocean, nothing; atmosphere, radiation = Radiation(ocean_emissivity=0, ocean_albedo=1))
