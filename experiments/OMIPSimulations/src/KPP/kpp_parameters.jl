...
Parameters of the K-Profile Parameterization (Large, McWilliams,
& Doney, 1994) as implemented in MITgcm/pkg/kpp.

Fields are grouped by subsystem: boundary-layer depth diagnosis,
Monin-Obukhov velocity scales, interior shear / convective mixing,
boundary-layer shape function, and numerical safeguards.
"""
...
Construct a `KPPParameters{FT}` with MITgcm defaults; override any field
via keyword.
"""
