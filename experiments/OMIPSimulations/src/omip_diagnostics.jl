...
function add_omip_diagnostics!(simulation;
    ...
    simulation.output_writers[:surface] = JLD2Writer(simulation.model, surface_outputs;
    ...
    simulation.output_writers[:fields] = JLD2Writer(simulation.model, field_outputs;
    ...
    simulation.output_writers[:averages] = JLD2Writer(simulation.model, average_outputs;
