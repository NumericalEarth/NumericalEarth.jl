...
import NumericalEarth.CoupledModels.InterfaceComputations: surface_specific_humidity
    ...
    for arch in test_architectures
        ...
        CUDA.@allowscalar begin
            ...
            for atmosphere_ocean_interface_temperature in (BulkTemperature(), SkinTemperature(DiffusiveFlux(1, 1e-2)))
                ...
                coupled_model    = CoupledModel(ocean; atmosphere, interfaces)
        ...
        CUDA.@allowscalar begin
            ...
            coupled_model = CoupledModel(ocean, sea_ice; atmosphere, radiation)
        ...
        earth = CoupledModel(ocean, sea_ice; atmosphere, radiation=Radiation())
