...
spectral_grid = SpeedyWeather.SpectralGrid(truncation=52, nlayers=3, Grid=FullClenshawGrid)
...
earth_model = EarthSystemModel(; atmosphere=atmos, sea_ice=default_sea_ice(), ocean)
