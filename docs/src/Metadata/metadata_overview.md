...
| `OpenLandMapSoilDB` | 30 m global soil texture (sand, silt, clay) and fine-earth bulk density over 0–100 cm, read over a regional window, optionally at a lattice matched to the target grid (needs `ArchGDAL`) | [OpenLandMap STAC](https://stac.openlandmap.org/) |
