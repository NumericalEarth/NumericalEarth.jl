...
import NumericalEarth.CoupledModels:
    thermodynamics_parameters,
    boundary_layer_height,
    surface_layer_height

const SpeedySimulation = SpeedyWeather.Simulation
const SpeedyCoupledModel = NumericalEarth.CoupledModel{<:Any, <:SpeedySimulation}
const SpeedyNoSeaIceCoupledModel = NumericalEarth.CoupledModel{<:Union{Nothing, NumericalEarth.SeaIces.FreezingLimitedOceanTemperature}, <:SpeedySimulation}
