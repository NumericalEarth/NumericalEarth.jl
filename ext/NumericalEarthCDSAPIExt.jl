...
function download_glofas_month(name, dataset, dates; region, dir, skip_existing, cleanup)
    ...
    @root begin
        ...
        foreach_nc(tmp_path, dir) do nc_path
            split_era5_nc_multistep(nc_path, nc_triples, GLOFAS_COORD_VARS, ERA5_TIME_DIMNAMES)
        end
...
Downloads.download(metadata::NumericalEarth.DataWrangling.CopernicusLandAlbedo.CopernicusAlbedoDatasetMetadata; kwargs...) =
