...
NumericalEarth.EarthSystemModels.reference_density(ocean::Simulation{<:HydrostaticFreeSurfaceModel}) = reference_density(ocean.model.buoyancy.formulation)
NumericalEarth.EarthSystemModels.reference_density(buoyancy_formulation::SeawaterBuoyancy) = reference_density(buoyancy_formulation.equation_of_state)
NumericalEarth.EarthSystemModels.reference_density(eos::TEOS10EquationOfState) = eos.reference_density

NumericalEarth.EarthSystemModels.heat_capacity(ocean::Simulation{<:HydrostaticFreeSurfaceModel}) = heat_capacity(ocean.model.buoyancy.formulation)
NumericalEarth.EarthSystemModels.heat_capacity(buoyancy_formulation::SeawaterBuoyancy) = heat_capacity(buoyancy_formulation.equation_of_state)

function NumericalEarth.EarthSystemModels.heat_capacity(::TEOS10EquationOfState{FT}) where FT
