...
@inline function EarthSystemModels.InterfaceComputations.air_sea_interface_radiation_state(rk, exchanger_state, i, j, k, grid, time)
    σ = rk.σ
...
@inline function EarthSystemModels.InterfaceComputations.air_sea_ice_interface_radiation_state(rk, exchanger_state, i, j, k, grid, time)
    σ = rk.σ
    @inbounds ℐꜜˢʷ = exchanger_state.ℐꜜˢʷ[i, j, 1]
    @inbounds ℐꜜˡʷ = exchanger_state.ℐꜜˡʷ[i, j, 1]
