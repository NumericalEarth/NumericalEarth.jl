...
using NumericalEarth.EarthSystemModels: EarthSystemModel, sea_ice_concentration
using NumericalEarth.EarthSystemModels.InterfaceComputations: convert_to_kelvin
...
"""
NumericalEarth.EarthSystemModels.apply_air_sea_radiative_fluxes!(::EarthSystemModel{<:Nothing}) = nothing

function NumericalEarth.EarthSystemModels.apply_air_sea_radiative_fluxes!(coupled_model::EarthSystemModel)
