#####
##### IGBP land-cover → drag-partition parameters, class-average canopy heights, and
##### non-vegetated constants. IGBP class integers follow MODIS MCD12Q1 (`LC_Type1`):
...
##### non-vegetated constants are Tables 2–4 of Borak et al. (2025).
#####
...
Representative class-average canopy height (m) for an IGBP class (Table 4). Returns `0`
for non-vegetated classes. Used as the fallback height only where the measured
canopy-height field is missing over a vegetated cell.
"""
