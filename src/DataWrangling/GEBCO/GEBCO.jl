...
Data source: https://www.gebco.net/data-products-gridded-bathymetry-data/gebco2026-grid
"""
struct GEBCO2026 <: AbstractStaticBathymetry end

const GEBCO2026Metadatum = Metadatum{<:GEBCO2026}
...
dataset_variable_name(::GEBCO2026Metadatum) = GEBCO_bathymetry_variable_names[:bottom_height]
...
DataWrangling.metadata_url(::GEBCO2026Metadatum)                        = GEBCO_2026_nc_url
metadata_filename(::GEBCO2026, name, date, bounding_box)                = GEBCO_2026_nc_filename

function Downloads.download(metadatum::GEBCO2026Metadatum)
    filepath = metadata_path(metadatum)

    @root if !isfile(filepath)
        @info "Downloading GEBCO 2026 to $(metadatum.dir)..."
        ...
        @info "GEBCO 2026 download complete."
    end
