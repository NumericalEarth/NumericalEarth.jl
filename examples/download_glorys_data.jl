...
# coords_path = NumericalEarth.DataWrangling.download(static_meta)
...
# T_en4_path = NumericalEarth.DataWrangling.download(T_en4_meta)
...
T_path = NumericalEarth.DataWrangling.download(T_meta)
