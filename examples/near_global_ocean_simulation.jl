...
# to calculate turbulent fluxes using bulk formulae, see [`InterfaceComputations`](@ref NumericalEarth.CoupledModels.InterfaceComputations).
...
coupled_model = CoupledModel(ocean; atmosphere, radiation)
